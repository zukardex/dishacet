...
session_start();
    if(isset($_POST["email"]) && isset($_POST["password"])){
        ...
        if($_POST['email'] == $convenorEmail && $_POST['password'] == $convenorPassword){
            $_SESSION['convenor'] = $convenorSession;
...
<head>
    ...
    <title>Login -  DISHA Convenor /Core Committee</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h4 class="text-dark mb-4">Login <br>  DISHA Convenor /Core Committee</h4>
                                    </div>
